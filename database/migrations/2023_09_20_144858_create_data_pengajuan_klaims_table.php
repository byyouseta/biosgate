...
class CreateDataPengajuanKlaimsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('data_pengajuan_klaims', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('data_pengajuan_klaims');
    }
}
