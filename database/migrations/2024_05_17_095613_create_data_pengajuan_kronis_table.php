...
class CreateDataPengajuanKronisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('data_pengajuan_kronis', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('data_pengajuan_kronis');
    }
}
