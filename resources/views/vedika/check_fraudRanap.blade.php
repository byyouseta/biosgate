                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" id="no-hp-form">
                                    ...
                                    <input type="text" class='form-control' value="@foreach ($diagnosa as $index => $dataDiagnosa)
{{ $dataDiagnosa->kd_penyakit }}, @endforeach " readonly>
                                </div>
                                <div class="form-group" id="no-hp-form">
            ...
            <div class="col-md-12">
                <div class="card mb-5">
                    ...
                    <div class="card-body">
                        <form action="/vedika/fraud/{{ Crypt::encrypt($data->id) }}/storeranap" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    {{-- <div class="col-md-12"> --}}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="1" name="up_coding"
                                                id="up_coding1" {{ $data->up_coding == '1' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="up_coding1">YA</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="0" name="up_coding"
                                                id="up_coding0" {{ $data->up_coding == '0' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="1"
                                                name="phantom_billing" id="phantom_billing1" {{ $data->phantom_billing
                                            == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="0"
                                                name="phantom_billing" id="phantom_billing0" {{ $data->phantom_billing
                                            == '0' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="0" name="cloning"
                                                id="cloning0" {{ $data->cloning == '0' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="1" name="inflated_bills"
                                                id="inflated_bills1" {{ $data->inflated_bills == '1' ? 'checked' : ''
                                            }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="0" name="inflated_bills"
                                                id="inflated_bills0" {{ $data->inflated_bills == '0' ? 'checked' : ''
                                            }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="1" name="pemecahan"
                                                id="pemecahan1" {{ $data->pemecahan == '1' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="pemecahan1">YA</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="0" name="pemecahan"
                                                id="pemecahan0" {{ $data->pemecahan == '0' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="1" name="rujukan_semu"
                                                id="rujukan_semu1" {{ $data->rujukan_semu == '1' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="rujukan_semu1">YA</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="0" name="rujukan_semu"
                                                id="rujukan_semu0" {{ $data->rujukan_semu == '0' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="1" name="repeat_billing"
                                                id="repeat_billing1" {{ $data->repeat_billing == '1' ? 'checked' : ''
                                            }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="0" name="repeat_billing"
                                                id="repeat_billing0" {{ $data->repeat_billing == '0' ? 'checked' : ''
                                            }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check mr-3">
                                            <input class="form-check-input" type="radio" value="1" name="prolonged_los"
                                                id="prolonged_los1" {{ $data->prolonged_los == '1' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="prolonged_los1">YA</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="0" name="prolonged_los"
                                                id="prolonged_los0" {{ $data->prolonged_los == '0' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check mr-3">
                                            <input class="form-check-input" type="radio" value="1"
                                                name="manipulasi_kels" id="manipulasi_kels1" {{ $data->manipulasi_kels
                                            == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="0"
                                                name="manipulasi_kels" id="manipulasi_kels0" {{ $data->manipulasi_kels
                                            == '0' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check mr-3">
                                            <input class="form-check-input" type="radio" value="1" name="re_admisi"
                                                id="re_admisi1" {{ $data->re_admisi == '1' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="re_admisi1">YA</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="0" name="re_admisi"
                                                id="re_admisi0" {{ $data->re_admisi == '0' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 mt-3 form-group" id="keterangan-keluhan-form">
                                        ...
                                        <textarea class="form-control" placeholder="Isikan Klarifikasi"
                                            name="klarifikasi" id="klarrifikasi"
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 form-group" id="keterangan-keluhan-form">
                                        ...
                                        <textarea class="form-control" placeholder="Isikan Keterangan" name="keterangan"
                                            id="keterangan" style="height: 100px">{{ $data->keterangan }}</textarea>
                                    </div>
                                </div>
                            </div>
