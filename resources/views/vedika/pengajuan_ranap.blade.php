                ...
                <div class="card">
                    <div class="card-header">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <form action="/vedika/pengajuan/ranap" method="GET">
                                    <div class="input-group">
                                        <select name="periode" class="form-control" required>
                                            <option value="">Pilih Periode</option>
                                            @foreach ($dataPeriode as $periode)
                                            <option value="{{ $periode->id }}" {{ $periode->id ==
                                                Request::get('periode') ? 'selected' : '' }}>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">{{ $data->nama_pasien }}
                                            <a href="/vedika/ranap/{{ Crypt::encrypt($data->no_rawat) }}/detail"
                                                ...
                                                <span class="badge badge-info"><i class="fas fa-search"></i></span></a>
                                            @can('vedika-fraud-create')
                                            @if (\App\FraudRanap::checkFraud($data->id) == false)
                                            @can('vedika-fraud-create')
                                            <a href="/vedika/fraud/{{ Crypt::encrypt($data->id) }}/{{ Request::get('periode') }}/storeranap"
                                                class="btn btn-sm " data-toggle="tooltip" data-placement="bottom"
                                                title="Tambah data Fraud">
                                                <span class="badge badge-warning"><i class="fas fa-plus-circle"></i>
                                                    Fraud</span></a>
                                            @endcan
                                            @else
                                            <a href="/vedika/fraud/{{ Crypt::encrypt($data->id) }}/deleteranap"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            @can('vedika-upload')
                                ...
                                <a href="/vedika/pengajuan/{{ Crypt::encrypt(Request::get('periode')) }}/makezipranap"
                                    class="btn btn-warning btn-sm btn-block">
                                    <i class="far fa-file-archive"></i> Arsipkan Berkas Ranap</a>
                            @endcan
                            <a href="/vedika/pengajuan/ranap/{{ Crypt::encrypt(Request::get('periode')) }}/downloadzip"
