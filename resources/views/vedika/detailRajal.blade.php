                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle py-0" colspan="2">
                                        :
                                        {{
                                        \Carbon\Carbon::parse($pasien->tgl_lahir)->diff(\Carbon\Carbon::parse($dataOperasi->tgl_operasi))->format('%y
                                        Th %m Bl %d Hr') }}
                                    </td>
                                    <td class="align-middle py-0">
                                        Ruang
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle py-0 border border-dark border-left-0 border-right-0 border-top-0"
                                        ...
                                        \App\Vedika::getPegawai($dataOperasi->operator1)->nama : '-' !!}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="align-middle py-0">
                                ...
                                <tr>
                                    <td class="align-middle py-0 pl-5" colspan="3">
                                        {!! $dataOperasi->operator2 != '-' ?
                                        \App\Vedika::getPegawai($dataOperasi->operator2)->nama : '-' !!}
                                    </td>
                                    <td class="align-middle py-0 pl-5" colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle py-0 pl-5" colspan="2">
                                        {!! $dataOperasi->dokter_anestesi != '-' ?
                                        \App\Vedika::getPegawai($dataOperasi->dokter_anestesi)->nama : '-' !!}
                                    </td>
                                    <td
                                        class="align-middle py-0 border border-dark border-bottom-0 border-right-0 border-top-0">
                                    </td>
                                ...
                                <tr>
                                    <td class="align-middle py-0 pl-5" colspan="3">
                                        {!! $dataOperasi->instrumen != '-' ?
                                        \App\Vedika::getPegawai($dataOperasi->instrumen)->nama : '-' !!}
                                    </td>
                                    <td class="align-middle py-0 pl-5" colspan="2">
                                ...
                                <tr>
                                    <td class="align-middle py-0 pl-5" colspan="3">
                                        {!! $dataOperasi->dokter_anak != '-' ?
                                        \App\Vedika::getPegawai($dataOperasi->dokter_anak)->nama : '-' !!}
                                    </td>
                                    <td class="align-middle py-0 pl-5" colspan="2">
                                        {!! $dataOperasi->bidan != '-' ?
                                        \App\Vedika::getPegawai($dataOperasi->bidan)->nama : '-' !!}
                                    </td>
                                    <td
                                        class="align-middle py-0 border border-dark border-bottom-0 border-right-0 border-top-0">
                                    </td>
                                ...
                                <tr>
                                    <td class="align-middle py-0 pl-5" colspan="3">
                                        {!! $dataOperasi->dokter_umum != '-' ?
                                        \App\Vedika::getPegawai($dataOperasi->dokter_umum)->nama : '-' !!}
                                    </td>
                                    <td class="align-middle py-0 pl-5" colspan="2">
                                        {!! $dataOperasi->omloop != '-' ?
                                        \App\Vedika::getPegawai($dataOperasi->omloop)->nama : '-' !!}
                                    </td>
                                    <td
                                        class="align-middle py-0 text-center border border-dark border-bottom-0 border-right-0 border-top-0">
                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ $index == 0 ? 'active' : '' }}" id="custom-tabs-four-home-tab"
                                    data-toggle="pill" href="#custom-tabs-lap-{{ $listOperasi->tgl_operasi }}"
                                    role="tab" aria-controls="custom-tabs-four-home" aria-selected="true"> Hasil
                                    Lab {{ $listOperasi->tgl_operasi }}</a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-four-tabContent">
                            @foreach ($dataOperasi2 as $index => $listOperasi)
                            <div class="tab-pane fade show {{ $index == 0 ? 'active' : '' }}"
                                id="custom-tabs-lap-{{ $listOperasi->tgl_operasi }}" role="tabpanel"
                                aria-labelledby="#custom-tabs-lap-{{ $listOperasi->tgl_operasi }}">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-borderless mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                @php
                                                $dokterOperator = \App\Vedika::getPegawai(
                                                $listOperasi->operator1,
                                                )->nama;
                                                $draf = preg_split(
                                                '/\r\n|\r|\n/',
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $pasien->no_rawat }}" name="no_rawat"
                                    readonly />
                                <input type="hidden" class="form-control" value="Rajal" name="statusRawat" readonly />
                            </div>
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $pasien->nm_poli }}" name="nm_poli"
                                    readonly />
                            </div>
                            <div class="form-group">
                                <label>Periode</label>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label>No Resep</label>
                                <input type="text" class="form-control" value="{{ $statusPengajuanKronis->no_resep }}"
                                    name="no_resep" required />
                            </div>
                            <div class="form-group">
                                <label>No SEP</label>
                                <input type="text" class="form-control"
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="periode" class="form-control" required>
                                    <option value="">Pilih</option>
                                    @foreach ($periodeKlaim as $periode)
                                    <option value="{{ $periode->id }}" {{ $statusPengajuanKronis->periode_klaim_id ==
                                        $periode->id ? 'selected' : '' }}>
                                        {{ $periode->periode }}</option>
                                    @endforeach
                                </select>
