                            ...
                            <table class="table table-borderless py-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pt-0 pb-0" style="width: 45%">: {{ $pasien->no_rkm_medis }}</td>
                                    </tr>
                                    <tr>
                                        <td class="pt-0 pb-0" style="width: 15%">No.Rawat</td>
                                        <td class="pt-0 pb-0" style="width: 45%">: {{ $pasien->no_rawat }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pt-0 pb-0">: {{ $pasien->no_resep }}</td>
                                    </tr>
                                </tbody>
                            </table>
                            <table class="table table-border table-sm">
                                <tbody>
                                    @php
                                        $totalBiaya = 0;
                                    @endphp
                                    @foreach ($data as $index => $listObat)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{ number_format((int) $listObat->jml, 1, '.', ',') }}
                                                {{ $listObat->kode_sat }}
                                            </td>
                                            <td class="text-right">
                                                Rp {{ number_format((int) $listObat->total, 2, '.', ',') }}
                                                @php
                                                    $totalBiaya = $totalBiaya + (int) $listObat->total;
                                                @endphp
                                            </td>
                                        </tr>
                                    @endforeach
                            ...
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td class="text-center pt-0 pb-0">Surakarta,
                                        {{ \Carbon\Carbon::parse($pasien->tgl_perawatan)->format('d-m-Y') }}</td>
                                </tr>
                                <tr>
                                    @php
                                        $qr_dokter = 'Dikeluarkan di RSUP SURAKARTA, Kabupaten/Kota Surakarta Ditandatangani secara elektronik oleh' . "\n" . $pasien->nm_dokter . "\n" . 'ID ' . $pasien->kd_dokter . "\n" . \Carbon\Carbon::parse($pasien->tgl_perawatan)->format('d-m-Y');
