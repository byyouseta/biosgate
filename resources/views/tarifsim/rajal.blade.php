                    ...
                    <div class="card-header">
                        <div class="card_title">{{ Session::get('anak') }}
                            <div class="float-right">
                                <a href="/tarifsimrs/rajal/exportexcel" class="btn btn-success btn-sm"
                                    target="_blank">EXPORT
                                    EXCEL</a>
                                <a href="/tarifsimrs/rajal/template" class="btn btn-secondary btn-sm"
                                    target="_blank">TEMPLATE
                                    EXCEL</a>
                                <button href="/tarifsimrs/rajal/importexcel" class="btn btn-info btn-sm"
                            ...
                            <table class="table table-bordered table-hover table-sm display nowrap" id="example"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="align-middle">Unit/Poli</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    <div class="modal fade" id="modal-import-excel" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="/tarifsimrs/rajal/importexcel" class="form-prevent" enctype="multipart/form-data">
                    @csrf
