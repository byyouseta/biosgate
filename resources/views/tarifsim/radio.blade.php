                    ...
                    <div class="card-header">
                        <div class="card_title">{{ Session::get('anak') }}
                            <div class="float-right">
                                <a href="/tarifsimrs/radiologi/exportexcel" class="btn btn-success btn-sm"
                                    target="_blank">EXPORT
                                    EXCEL</a>
                                <a href="/tarifsimrs/radiologi/template" class="btn btn-secondary btn-sm"
                                    target="_blank">TEMPLATE
                                    EXCEL</a>
                                <button href="/tarifsimrs/radiologi/importexcel" class="btn btn-info btn-sm"
                            ...
                            <table class="table table-bordered table-hover table-sm display nowrap" id="example"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="align-middle">Js Medis Perujuk</th>
                                        ...
                                        <th class="align-middle">Ttl Tarif</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ $summary->tarif_perujuk }}</td>
                                        <td class="text-right">{{ $summary->tarif_tindakan_dokter }}</td>
                                        <td class="text-right">{{ $summary->tarif_tindakan_petugas }}</td>
                                        <td class="text-right">{{ $summary->kso }}</td>
                                        <td class="text-right">{{ $summary->menejemen }}</td>
                                        <td class="text-right">{{ $summary->total_byr }}</td>
    ...
    <div class="modal fade" id="modal-import-excel" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="/tarifsimrs/radiologi/importexcel" class="form-prevent" enctype="multipart/form-data">
                    @csrf
