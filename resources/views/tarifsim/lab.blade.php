                    ...
                    <div class="card-header">
                        <div class="card_title">{{ Session::get('anak') }}
                            <div class="float-right">
                                <a href="/tarifsimrs/lab/exportexcel" class="btn btn-success btn-sm"
                                    target="_blank">EXPORT
                                    EXCEL</a>
                                <a href="/tarifsimrs/lab/template" class="btn btn-secondary btn-sm"
                                    target="_blank">TEMPLATE
                                    EXCEL</a>
                                <button href="/tarifsimrs/lab/importexcel" class="btn btn-info btn-sm"
    ...
    <div class="modal fade" id="modal-import-excel" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="/tarifsimrs/lab/importexcel" class="form-prevent" enctype="multipart/form-data">
                    @csrf
