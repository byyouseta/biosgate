                            ...
                            <table class="table table-bordered table-hover table-sm display nowrap" id="example2">
                                <thead>
                                    <tr>
                                        ...
                                        {{-- <th class="align-middle">KTP Dokter</th> --}}
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <span class="badge badge-secondary badge-sm">{{ $summary->stts }}</span>
                                            @else
                                            {{ $summary->stts }}
                                            @endif
                                        </td>
                                        @php
                                        $dataEncounter = \App\ResponseSatuSehat::getEncounter($summary->no_rawat);
                                        @endphp
                                        <td>
                                            @if ($dataEncounter)
                                            @php
