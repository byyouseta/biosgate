                        ...
                        <div class="card-header">
                            <div class="card_title">{{ Session::get('anak') }}
                                <div class="float-right">
                                    <form action="/satusehat/vaksin/summary" method="GET">
                                    ...
                                    <tbody>
                                        @foreach ($kunjungan as $summary)
                                            <tr>
                                                ...
                                                <td>{{ $summary->nm_dokter }}</td>
                                                <td>{{ $summary->kfa ?? '-' }}</td>
                                                <td>{{ $summary->encounter ?? '-' }}</td>
                                                @php
                                                ...
                                                <td>
                                                    {{ $imunisasi ? $imunisasi->immunization_id : '-' }}
                                                </td>

                                                <td>
                                                    @if (!$imunisasi)
                                                        <a
                                                            href="{{ route('satuSehat.sendImmunization', Crypt::encrypt("$summary->no_rawat-$summary->kd_jenis_prw")) }}">
