                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card_title">{{ Session::get('anak') }}
                                <div class="float-right">
                                    <form action="/satusehat/lab/summary" method="GET">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-hover table-sm display nowrap" id="example2">
                                ...
                                <tbody>
                                    @foreach ($dataPermintaanLab as $summary)
                                        <tr>
                                            ...
                                            {{-- <td>
                                                @if (empty($summary->dataResponse->responseObservation))
                                                    -
                                                @else
                                                    @foreach ($summary->dataResponse->responseObservation as $dataObservation)
                                                        {{ $dataObservation->observation_id }}<br>
                                                    @endforeach
                                                @endif
                                            </td>
                                            <td>{{ $summary->dataResponse->report_id ?? '-' }}</td> --}}
                                            <td>{{ $summary->dataResponse->created_at ?? '-' }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
