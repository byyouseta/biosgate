        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-sm-12">
                    <form action="/berkasrm/hakkewajiban/edit" method="POST">
                        @csrf
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox"
                                                                ...
                                                                {{ $berkas->kewajiban1 == true ? 'checked' : '' }}>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox"
                                                                ...
                                                                {{ $berkas->kewajiban2 == true ? 'checked' : '' }}>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox"
                                                                ...
                                                                {{ $berkas->kewajiban3 == true ? 'checked' : '' }}>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox"
                                                                ...
                                                                {{ $berkas->kewajiban4 == true ? 'checked' : '' }}>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox"
                                                                ...
                                                                {{ $berkas->kewajiban5 == true ? 'checked' : '' }}>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox"
                                                                ...
                                                                {{ $berkas->kewajiban6 == true ? 'checked' : '' }}>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox"
                                                                ...
                                                                {{ $berkas->kewajiban7 == true ? 'checked' : '' }}>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox"
                                                                ...
                                                                {{ $berkas->kewajiban8 == true ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="informan"
                                                        value="{{ $berkas->user->name }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                {{ $berkas->statusPj == 'pasien' ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="pjPasien">Pasien</label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="statusPj" id="pjKeluarga" value="keluarga"
                                                                {{ $berkas->statusPj == 'keluarga' ? 'checked' : '' }}>
