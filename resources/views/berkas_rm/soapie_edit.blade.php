                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="tab-content" id="custom-content-below-tabContent">
                                        ...
                                        <div class="tab-pane fade  show active" id="custom-content-below-settings"
                                            ...
                                            <form method="POST" action="{{ route('berkasrm.soapieUpdate') }}">
                                                @csrf
                                                {{-- hidden input --}}
                                                <input type="hidden" name="noRawat" value="{{ $data->no_rawat }}">
                                                <input type="hidden" name="tglPerawatan"
                                                    value="{{ $data_inputRalan->jam_rawat }}">
                                                <div class="row mt-2">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="petugas" class="form-control select2">
                                                                @foreach ($data_pegawai as $listPetugas)
                                                                    <option value="{{ $listPetugas->nik }}"
                                                                        {{ $listPetugas->nik == $data_inputRalan->nip ? 'selected' : '' }}>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="tanggal"
                                                                value="{{ \Carbon\Carbon::parse($data_inputRalan->tgl_perawatan . ' ' . $data_inputRalan->jam_rawat)->format('Y-m-d H:i:s') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="imun_ke" class="form-control">
                                                                ...
                                                                @for ($i = 1; $i <= 13; ++$i)
                                                                    <option value="{{ $i }}"
                                                                        {{ $i == $data_inputRalan->imun_ke ? 'selected' : '' }}>
                                                                        {{ $i }}</option>
                                                                @endfor
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="alergi"
                                                                value="{{ $data_inputRalan->alergi ? $data_inputRalan->alergi : '' }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="subjeck">Subjek</label>
                                                            <textarea name="keluhan" id="" rows="3" class="form-control">{{ $data_inputRalan->keluhan }}</textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="no_hp">Objek</label>
                                                            <textarea name="pemeriksaan" id="" rows="3" class="form-control">{{ $data_inputRalan->pemeriksaan }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="subjeck">Asesmen</label>
                                                            <textarea name="penilaian" id="" rows="3" class="form-control">{{ $data_inputRalan->penilaian }}</textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="no_hp">Plan</label>
                                                            <textarea name="rtl" id="" rows="3" class="form-control">{{ $data_inputRalan->rtl }}</textarea>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control"
                                                                    name="suhu_tubuh"
                                                                    value="{{ $data_inputRalan->suhu_tubuh != null ? $data_inputRalan->suhu_tubuh : '' }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" name="tensi"
                                                                    value="{{ $data_inputRalan->tensi ? $data_inputRalan->tensi : '' }}">
                                                                <div class="input-group-append">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control"
                                                                    name="respirasi"
                                                                    value="{{ $data_inputRalan->respirasi }}">
                                                                <div class="input-group-append">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="kesadaran" class="form-control">
                                                                <option value="Compos Mentis"
                                                                    {{ $data_inputRalan->kesadaran == ' Compos Mentis' ? 'selected' : '' }}>
                                                                    Compos Mentis</option>
                                                                <option value="Somnolence"
                                                                    {{ $data_inputRalan->kesadaran == 'Somnolence' ? 'selected' : '' }}>
                                                                    Somnolence</option>
                                                                <option value="Sopor"
                                                                    {{ $data_inputRalan->kesadaran == 'Sopor' ? 'selected' : '' }}>
                                                                    Sopor</option>
                                                                <option value="Coma"
                                                                    {{ $data_inputRalan->kesadaran == ' Coma' ? 'selected' : '' }}>
                                                                    Coma</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="instruksi" id="" rows="3" class="form-control">{{ $data_inputRalan->instruksi }}</textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="no_hp">Evaluasi</label>
                                                            <textarea name="evaluasi" id="" rows="3" class="form-control">{{ $data_inputRalan->evaluasi }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <hr>
                                                ...
                                                <div class="float-right mt-3">
                                                    <a href="{{ route('berkasrm.soapie', Crypt::encrypt($listSoapie->no_rawat)) }}"
                                                        type="button" class="btn btn-secondary">Batal</a>
