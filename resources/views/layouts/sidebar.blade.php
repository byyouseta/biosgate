   ...
   with font-awesome or any other icon font library -->
            ...
            <li class="nav-item @if (@session('ibu') == 'BIOS facelift') menu-open @endif">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="/layanan/bor"
                            class="nav-link @if (@session('anak') == 'Data Statistik') active @endif">
                    ...
                    <li class="nav-item">
                        <a href="/layanan/visit"
                            class="nav-link @if (@session('anak') == 'Data Visit/IKT') active @endif">
            ...
            <li class="nav-item @if (@session('ibu') == 'RS Online') menu-open @endif">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="/rsonline/antrian" class="nav-link @if (@session('anak') == 'Antrian') active @endif">
            ...
            <li class="nav-item @if (@session('ibu') == 'Tarif SIMRS') menu-open @endif">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="/tarifsimrs/lab" class="nav-link @if (@session('anak') == 'Tarif Lab') active @endif">
                            <i class="nav-icon fas fa-file-invoice-dollar"></i>
                            <p>
                                Tarif Lab
                            </p>
            ...
            <li class="nav-item @if (@session('ibu') == 'Satu Sehat') menu-open @endif">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item @if (@session('anak') == 'Rajal Satu Sehat') menu-is-opening menu-open @endif">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/satusehat" class="nav-link @if (@session('cucu') == 'Summary') active @endif">
            ...
            Auth::user()->can('vedika-periode-list'))
