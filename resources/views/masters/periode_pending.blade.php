                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Periode Pangajuan Klaim Pending
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col text-center">
                                                    <div class="btn-group">
                                                        <a href="/master/vedika/klaimpending/{{ Crypt::encrypt($dataPeriode->id) }}/edit"
                                                            class="btn btn-warning btn-sm" data-toggle="tooltip"
                                                            data-placement="bottom" title="Edit Periode">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a>
                                                        <a href="/master/vedika/klaimpending/{{ Crypt::encrypt($dataPeriode->id) }}/delete"
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="/master/vedika/klaimpending">
                    @csrf
                    <div class="modal-header">
                        <h4 class="modal-title">Tambah Periode Pending</h4>
