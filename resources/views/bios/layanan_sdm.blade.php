        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-4">
                    <div class="card">
                        <div class="card-header">
                            <div class="card_title">Jumlah Non Medis Administrasi hari ini</div>
                        </div>
                        <div class="card-body">
                            <div style="overflow-x:auto;">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>{{ $nonmedisAdministrasi->tgl_transaksi }}</td>
                                            <td>{{ $nonmedisAdministrasi->pns }}</td>
                                            <td>{{ $spesialis->pppk }}</td>
                                            <td>{{ $nonmedisAdministrasi->non_pns_tetap }}</td>
                                            <td>{{ $nonmedisAdministrasi->kontrak }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                ...
                <div class="col-4">
                    <div class="card">
                        <div class="card-header">
                            <div class="card_title">Jumlah Sanitarian hari ini</div>
                        </div>
                        <div class="card-body">
                            <div style="overflow-x:auto;">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>{{ $sanitarian->tgl_transaksi }}</td>
                                            <td>{{ $sanitarian->pns }}</td>
                                            <td>{{ $spesialis->pppk }}</td>
                                            <td>{{ $sanitarian->non_pns_tetap }}</td>
                                            <td>{{ $sanitarian->kontrak }}</td>
                                        </tr>
                                    </tbody>
                                </table>
