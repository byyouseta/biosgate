            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        @endphp
                        <div class="card-body">
                            <form action="/saldo/pengelolaankas/lihat" method="GET">
                                ...
                                <tbody>
                                    @foreach ($data as $data)
                                        <tr>
                                            ...
                                            <td class="text-right">{{ number_format($data->nilai_deposito, 2, ',', '.') }}
                                            </td>
                                            <td class="text-right">{{ number_format($data->nilai_bunga, 2, ',', '.') }}
                                            </td>
                                            ...
                                            <td>
                                                <div class="col text-center">
                                                    <div class="btn-group">
                                                        <a href="/saldo/pengelolaankas/{{ Crypt::encrypt($data->id) }}/edit"
                                                            class="btn btn-warning btn-sm "
                                                            data-toggle="tooltip" data-placement="bottom" title="Edit" @cannot('bios-saldo-edit') disabled @endcannot>
                                                            <i class="fas fa-pen"></i>
                                                        </a>
                                                        <a href="/saldo/pengelolaankas/{{ Crypt::encrypt($data->id) }}/delete"
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="/saldo/pengelolaankas/store">
                    @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="nilai_deposito" required>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="nilai_bunga" required>
                                    </div>
