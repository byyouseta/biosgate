                    ...
                    <div class="card">
                        <div class="card-header">
                            <button class="btn btn-primary btn-sm "
                                data-toggle="modal" data-target="#modal-default" @cannot('bios-pengeluaran-create') disabled @endcannot>
                            ...
                            <div class="btn-group float-right">
                                ...
                                <button
                                    ...
                                    data-toggle="modal" data-target="#modal-import" @cannot('bios-pemasukan-create') disabled @endcannot>
                                                ...
                                                <div class="col text-center">
                                                    <div class="btn-group">
                                                        <a href="/pengeluaran/edit/{{ Crypt::encrypt($data->id) }}"
                                                            ...
                                                            data-toggle="tooltip" data-placement="bottom" title="Edit" @cannot('bios-pengeluaran-edit') disabled @endcannot>
                                                            <i class="fas fa-pen"></i>
                                                        </a>
                                                        <a href="/pengeluaran/delete/{{ Crypt::encrypt($data->id) }}"
                                                            class="btn btn-danger btn-sm delete-confirm "
                                                            data-toggle="tooltip" data-placement="bottom" title="Delete" @if ($data->status == 1) disabled @endif @cannot('bios-pengeluaran-delete') disabled @endcannot>
