...
@section('content')
    <section class="content">
        <div class="container-fluid">
            ...
            <form role="form" action="/kanker/addpasien" method="post">
                {{ csrf_field() }}
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="noRawat" value="{{ $data->no_rawat }}"
                                        readonly />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        @php
                                            if (!empty(\App\Kelurahan::NamaKel($data->kd_kel))) {
                                                $namakel = \App\Kelurahan::NamaKel($data->kd_kel);
                                        ...
                                        @endphp
                                        <input type="text" class="form-control col-4"
                                            value="{{ $data->kd_kel }} - {{ $keterangan }}" readonly>
                                    </div>
                                ...
                                <div class="form-group">
                                    {{-- <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="AlamatTinggalSama"
                                            onclick="DisableAlamatTinggal">
                                        <label class="custom-control-label" for="AlamatTinggalSama">Alamat Tinggal sama
                                            dengan
                                            Alamat</label>
                                    </div> --}}
                                    ...
                                    <select name="caraMasuk" class="form-control" required>
                                        ...
                                        @foreach ($caraMasuk as $masuk)
                                            <option value="{{ $masuk->kode_cara_masuk_pasien }}"
                                                @if (old('caraMasuk') == $masuk->kode_cara_masuk_pasien) selected @endif>
                                    ...
                                    <select class="form-control" name="asalRujukan" id="asalRujukan"
                                        ...
                                        @foreach ($asalRujukan as $asal)
                                            <option value="{{ $asal->kode_asal_rujukan_pasien }}"
                                                @if (old('asalRujukan') == $asal->kode_asal_rujukan_pasien) selected @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fasyankesLain" id="fasyankesLain"
                                        value="{{ old('fasyankesLain') }}" disabled>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="DiagnosisMasuk"
                                        value="{{ $data->kd_penyakit }}_{{ $data->nm_penyakit }}" readonly />
                                </div>
                                <div class="form-group">
                                    ...
                                    @if ($data->status_lanjut == 'Ralan')
                                        ...
                                        @else
                                            ...
                                            @endphp
                                        @endif
                                    @elseif ($data->status_lanjut == 'Ralan')
                                        @php
                                            $status_lanjut = '2';
                                        @endphp
                                    @else
                                    ...
                                    @endif
                                    <div class="input-group">
                                        <select class="form-control select2" name="instalasi" id="instalasiUnit" required>
                                            <option>Sesuaikan Instalasi/Unit</option>
                                            @foreach ($instalasi as $instalasi)
                                                <option value="{{ $instalasi->kode_instalasi_unit }}"
                                                    {{ old('instalasi') == $instalasi->kode_instalasi_unit ? 'selected' : '' }}>
                                                    {{ $instalasi->instalasi_unit }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <input type="text" class="form-control col-4" value="{{ $data->status_lanjut }}"
                                            readonly />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="subinstalasi" id="subinstalasi" required>
                                            <option>Sesuaikan Sub Instalasi/Unit</option>
                                        </select>
                                        <input type="text" class="form-control col-4" value="{{ $data->kd_poli }}"
                                            readonly />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="diagnosaUtama form-control" name="diagnosaUtama" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="tglDiagnosis" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input"
                                            ...
                                            value="{{ old('tglDiagnosis') }}" autocomplete="off" required />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="tglKeluar" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input"
                                            ...
                                            value="{{ old('tglKeluar') }}" autocomplete="off" />
                                    ...
                                    <select class="form-control" name="caraKeluar" required>
                                        @foreach ($caraKeluar as $keluar)
                                            <option value="{{ $keluar->kode_cara_keluar }}"
                                                {{ old('caraKeluar') == $keluar->kode_cara_keluar ? 'selected' : '' }}>
                                                {{ $keluar->cara_keluar }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control" name="keadaanKeluar" required>
                                        @foreach ($keadaanKeluar as $keluar)
                                            <option value="{{ $keluar->kode_keadaan_keluar }}"
                                                {{ old('keadaanKeluar') == $keluar->kode_keadaan_keluar ? 'selected' : '' }}>
                                        ...
                                        <select class="form-control" name="caraBayar" required>
                                            ...
                                            @foreach ($caraBayar as $bayar)
                                                <option value="{{ $bayar->kode_cara_bayar }}"
                                                    {{ old('caraBayar') == $bayar->kode_cara_bayar ? 'selected' : '' }}>
                                                    {{ $bayar->cara_bayar }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="noBpjs"
                                            value="{{ old('noBpjs', $data->no_peserta) }}">
                                    </div>
