                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card_title">Summary data terkirim
                                <a href="/rsonline/antrian/clientadd" class="btn btn-sm btn-primary" target="_blank">Client
                                    Antrian RSOnline</a>

                                <div class="float-right">
                                    <form action="/rsonline/antrian" method="GET">
                                ...
                                <tbody>
                                    @foreach ($data as $summary)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- {{ $summary->statusKirim == 1 ? "<span class='badge badge-success'>Sudah</span>" : "<span class='badge badge-danger'>Belum</span>" }} --}}
