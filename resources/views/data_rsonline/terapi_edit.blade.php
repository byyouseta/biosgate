...
@section('content')
    <section class="content">
        <div class="container-fluid">
            ...
            <form role="form" action="/rsonline/pasienterlapor/patchterapi/{{ $data->lapTerapiId }}" method="post">
                {{ csrf_field() }}
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Edit Laporan Terapi Pasien</h3>
                    </div>
                    <!-- /.box-header -->
